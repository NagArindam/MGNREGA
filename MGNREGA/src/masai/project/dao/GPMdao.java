...
public interface GPMdao {
	...
	public String GPMLogin(String GPMphoneno, String GPMpassword);
	...
	public String assignEmployeeToAProject(int eid, int pid)throws EmployeeException, ProjectException;
